...
const Header = ({ classes, isSidebarOpened, toggleSidebar, ...props }) => (
  <AppBar position="fixed" className={classes.appBar}>
    <Toolbar className={classes.toolbar}>
      ...
      <Typography variant="h6" weight="medium" className={classes.logotype}>Volkswagen Group Sweden - HeaderView.js</Typography>
      ...
      >
        ...
        >
          <AccountIcon className={classes.profileMenuIcon} /> Logga ut
        </MenuItem>
      </Menu>
    </Toolbar>
  </AppBar>
